...
namespace WebSearcher {
    public class UniversityOfEdinburgh : Searcher {
        ...
        public override void GetRes(object o) {
            ...
            for (int i = start; i < end; i++) {
                ...
                try {
                    ...
                    string uri = "https://www.era.lib.ed.ac.uk/discover?scope=%2F&query="+title+"&submit=";
                    ...
                    res = DealStr(res);
                    if (res.ToLower().Contains((title_old+"<span").ToLower())) {
                        dt.Rows[i]["isIn"] = "YES";
                    } else {
                        dt.Rows[i]["isIn"] = "NO";
                    }
