...
namespace WebSearcher {
    public class UniversityOfBristol : Searcher {
        ...
        public override void GetRes(object o) {
            ...
            for (int i = start; i < end; i++) {
                ...
                try {
                    ...
                    string title = title_old.Replace('&', ' ').Replace(' ', '+').Replace(",","%2C");

                    string uri = "http://research-information.bristol.ac.uk/en/searchall.html?searchall="+title;
